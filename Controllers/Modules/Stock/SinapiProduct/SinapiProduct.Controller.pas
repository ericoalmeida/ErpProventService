...
uses Facade.Model, SinapiProductInsert.Controller, SinapiProductUpdate.Controller,
...
begin
  FProductModel := TFacadeModel.New.moduleFacade.stockFactoryModel.sinapiProductModel;
end;
...
function TSinapiProductController.find(AValue: string): iSinapiProductController;
begin
  Result := Self;
