...
type
  ...
  iSinapiProductUpdateController = interface
    function productModel(AValue: iSinapiProductModel): iSinapiProductUpdateController;
    function selectedRecord(AValue: TTSTOSINAPIPRODUCT): iSinapiProductUpdateController;
    ...
    function averagePriceSinapi(AValue: Currency): iSinapiProductUpdateController;
  ...
  iSinapiProductDeleteController = interface
    function productModel(AValue: iSinapiProductModel): iSinapiProductDeleteController;
    function selectedRecord(AValue: TTSTOSINAPIPRODUCT): iSinapiProductDeleteController;
  ...
  iSinapiProductDuplicateController = interface
    ...
    function averagePrice(AValue: Currency): iSinapiProductDuplicateController;
    function averagePriceSinapi(AValue: Currency): iSinapiProductDuplicateController;
