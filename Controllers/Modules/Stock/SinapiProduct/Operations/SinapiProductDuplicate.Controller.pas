...
type
  ...
  public
    ...
    function productModel(AValue: iSinapiProductModel): iSinapiProductDuplicateController;
...
class function TSinapiProductDuplicateController.New: iSinapiProductDuplicateController;
begin
  Result := Self.Create;
end;
...
function TSinapiProductDuplicateController.productModel(AValue: iSinapiProductModel)
  : iSinapiProductDuplicateController;
begin
  Result := Self;
