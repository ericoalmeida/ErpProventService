...
type
  TSinapiProductInsertController = class(TInterfacedObject, iSinapiProductInsertController)
  private
  ...
  public
    ...
    function productModel(AValue: iSinapiProductModel): iSinapiProductInsertController;
    ...
    function averagePriceSinapi(AValue: Currency): iSinapiProductInsertController;
...
function TSinapiProductInsertController.averagePrice(AValue: Currency): iSinapiProductInsertController;
begin
  Result := Self;
  FAveragePrice := AValue;
end;

function TSinapiProductInsertController.averagePriceSinapi(AValue: Currency): iSinapiProductInsertController;
begin
  Result := Self;
  FAveragePriceSinapi := AValue;
end;

function TSinapiProductInsertController.codeSinapi(AValue: string): iSinapiProductInsertController;
begin
  Result := Self;
  FCodeSinapi := AValue;
end;

function TSinapiProductInsertController.companyId(AValue: string): iSinapiProductInsertController;
begin
  Result := Self;
  FCompanyId := AValue;
end;
...
function TSinapiProductInsertController.description(AValue: string): iSinapiProductInsertController;
begin
  Result := Self;
  FDescription := AValue;
end;
...
class function TSinapiProductInsertController.New: iSinapiProductInsertController;
begin
  Result := Self.Create;
end;

function TSinapiProductInsertController.originPrice(AValue: string): iSinapiProductInsertController;
begin
  Result := Self;
  FOriginPrice := AValue;
end;
...
function TSinapiProductInsertController.status(AValue: Integer): iSinapiProductInsertController;
begin
  Result := Self;
  FStatus := AValue;
end;

function TSinapiProductInsertController.unitMeasure(AValue: string): iSinapiProductInsertController;
begin
  Result := Self;
  FUnitMeasure := AValue;
end;

function TSinapiProductInsertController.userId(AValue: string): iSinapiProductInsertController;
begin
  Result := Self;
  FUserId := AValue;
end;

function TSinapiProductInsertController.productModel(AValue: iSinapiProductModel)
