...
uses SinapiProduct.Controller.interf, SinapiProduct.Model.interf, System.SysUtils,
  TSTOSINAPIPRODUCT.Entity.Model;

type
  TSinapiProductUpdateController = class(TInterfacedObject, iSinapiProductUpdateController)
  private
...
function TSinapiProductUpdateController.productModel(AValue: iSinapiProductModel)
...
class function TSinapiProductUpdateController.New: iSinapiProductUpdateController;
begin
  Result := Self.Create;
end;
...
function TSinapiProductUpdateController.selectedRecord(AValue: TTSTOSINAPIPRODUCT)
  : iSinapiProductUpdateController;
begin
  Result := Self;
