...
function TTypeExpenseDuplicateController.companyId(AValue: string)
  : iTypeExpenseDuplicateController;
begin
   Result := Self;
   FCompanyId := AValue;
...
function TTypeExpenseDuplicateController.status(AValue: Integer)
  : iTypeExpenseDuplicateController;
begin
   Result := Self;
   FStatus := AValue;
...
function TTypeExpenseDuplicateController.userId(AValue: string)
  : iTypeExpenseDuplicateController;
begin
   Result := Self;
   FUserId := AValue;
