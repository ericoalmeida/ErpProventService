...
function TVehicleInsertController.brand(AValue: string)
  : iVehicleInsertController;
begin
   Result := Self;
   FBrand := AValue;
...
function TVehicleInsertController.category(AValue: string)
  : iVehicleInsertController;
begin
   Result := Self;
   FCategory := AValue;
...
function TVehicleInsertController.companyId(AValue: string)
  : iVehicleInsertController;
begin
   Result := Self;
   FCompanyId := AValue;
...
function TVehicleInsertController.Model(AValue: string)
  : iVehicleInsertController;
begin
   Result := Self;
   FModel := AValue;
...
function TVehicleInsertController.status(AValue: Integer)
  : iVehicleInsertController;
begin
   Result := Self;
   FStatus := AValue;
...
function TVehicleInsertController.userId(AValue: string)
  : iVehicleInsertController;
begin
   Result := Self;
   FUserId := AValue;
