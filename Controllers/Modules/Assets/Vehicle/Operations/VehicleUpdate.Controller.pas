...
function TVehicleUpdateController.board(AValue: string): iVehicleUpdateController;
begin
  Result := Self;
  FBoard := AValue;
end;

function TVehicleUpdateController.brand(AValue: string): iVehicleUpdateController;
begin
  Result := Self;
  FBrand := AValue;
end;

function TVehicleUpdateController.category(AValue: string): iVehicleUpdateController;
begin
  Result := Self;
  FCategory := AValue;
end;

function TVehicleUpdateController.companyId(AValue: string): iVehicleUpdateController;
begin
  Result := Self;
  FCompanyId := AValue;
end;
...
function TVehicleUpdateController.description(AValue: string): iVehicleUpdateController;
begin
  Result := Self;
  FDescription := AValue;
end;
...
function TVehicleUpdateController.model(AValue: string): iVehicleUpdateController;
begin
  Result := Self;
  FModel := AValue;
end;
...
function TVehicleUpdateController.status(AValue: Integer): iVehicleUpdateController;
begin
  Result := Self;
  FStatus := AValue;
end;

function TVehicleUpdateController.userId(AValue: string): iVehicleUpdateController;
begin
  Result := Self;
  FUserId := AValue;
end;
