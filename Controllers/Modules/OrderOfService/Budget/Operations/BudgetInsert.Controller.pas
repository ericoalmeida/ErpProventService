...
type
  TBudgetInsertController = class(TInterfacedObject,
...
function TBudgetInsertController.companyId(AValue: string): iBudgetInsertController;
begin
  Result := Self;
  FCompanyId := AValue;
end;
...
function TBudgetInsertController.description(
  AValue: string): iBudgetInsertController;
begin
  Result := Self;
  FDescription := AValue;
end;
...
function TBudgetInsertController.emissionDate(AValue: TDateTime): iBudgetInsertController;
begin
  Result := Self;
...
function TBudgetInsertController.userId(AValue: string): iBudgetInsertController;
begin
  Result := Self;
  FUserId := AValue;
end;
