...
uses ServiceProvided.Controller.Interf,
  ServiceProvided.Model.Interf, Base.View.Interf, TORDSERVICESPROVIDED.Entity.Model;
...
type
  ...
  public
    ...
    function serviceProvidedModel(AValue: iServiceProvidedModel): iServiceProvidedDeleteController;
    function selectedRecord(AValue: TTORDSERVICESPROVIDED): iServiceProvidedDeleteController;
...
function TServiceProvidedDeleteController.serviceProvidedModel(AValue: iServiceProvidedModel)
  : iServiceProvidedDeleteController;
begin
  Result := Self;
...
class function TServiceProvidedDeleteController.New: iServiceProvidedDeleteController;
begin
  Result := Self.Create;
end;
...
function TServiceProvidedDeleteController.selectedRecord(AValue: TTORDSERVICESPROVIDED)
  : iServiceProvidedDeleteController;
begin
  Result := Self;
