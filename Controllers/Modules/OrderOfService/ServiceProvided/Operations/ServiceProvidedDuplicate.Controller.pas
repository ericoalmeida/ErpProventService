...
function TServiceProvidedDuplicateController.clientId(
  AValue: string): iServiceProvidedDuplicateController;
begin
  Result := Self;
  FClientId := AValue;
end;

function TServiceProvidedDuplicateController.companyId(
  AValue: string): iServiceProvidedDuplicateController;
begin
  Result := Self;
  FCompanyId := AValue;
...
function TServiceProvidedDuplicateController.operatorId(
  AValue: string): iServiceProvidedDuplicateController;
begin
  Result := Self;
  FOperatorId := AValue;
...
function TServiceProvidedDuplicateController.providedAt(
  AValue: TDate): iServiceProvidedDuplicateController;
begin
  Result := Self;
  FProvidedAt := AValue;
end;
...
function TServiceProvidedDuplicateController.machineId(
  AValue: string): iServiceProvidedDuplicateController;
begin
  Result := Self;
  FMachineId := AValue;
...
function TServiceProvidedDuplicateController.serviceId(
  AValue: string): iServiceProvidedDuplicateController;
begin
  Result := Self;
  FServiceId := AValue;
...
function TServiceProvidedDuplicateController.total(AValue: Currency): iServiceProvidedDuplicateController;
begin
  Result := Self;
  FTotal := AValue;
end;

function TServiceProvidedDuplicateController.totalHours(AValue: Integer): iServiceProvidedDuplicateController;
begin
  Result := Self;
  FTotalHours := AValue;
end;

function TServiceProvidedDuplicateController.totalKm(AValue: Double): iServiceProvidedDuplicateController;
begin
  Result := Self;
  FTotalKm := AValue;
end;

function TServiceProvidedDuplicateController.userId(AValue: string): iServiceProvidedDuplicateController;
begin
  Result := Self;
  FUserId := AValue;
end;
