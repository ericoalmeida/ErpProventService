...
function TServiceInsertController.companyId(AValue: string)
...
function TServiceInsertController.description(AValue: string)
  : iServiceInsertController;
begin
   Result := Self;
   FDescription := AValue;
...
function TServiceInsertController.price(AValue: Currency)
  : iServiceInsertController;
begin
   Result := Self;
   FPrice := AValue;
...
function TServiceInsertController.paymentType(AValue: Integer)
  : iServiceInsertController;
begin
   Result := Self;
   FPaymentType := AValue;
...
function TServiceInsertController.status(AValue: Integer)
  : iServiceInsertController;
begin
   Result := Self;
   FStatus := AValue;
...
function TServiceInsertController.userId(AValue: string)
  : iServiceInsertController;
begin
   Result := Self;
   FUserId := AValue;
