...
function TServiceUpdateController.companyId(AValue: string)
  : iServiceUpdateController;
begin
   Result := Self;
   FCompanyId := AValue;
...
function TServiceUpdateController.status(AValue: Integer)
  : iServiceUpdateController;
begin
   Result := Self;
   FStatus := AValue;
...
function TServiceUpdateController.userId(AValue: string)
  : iServiceUpdateController;
begin
   Result := Self;
   FUserId := AValue;
...
function TServiceUpdateController.description(AValue: string)
  : iServiceUpdateController;
begin
   Result := Self;
   FDescription := AValue;
...
function TServiceUpdateController.paymentType(AValue: Integer)
  : iServiceUpdateController;
begin
   Result := Self;
   FPaymentType := AValue;
...
function TServiceUpdateController.price(AValue: Currency)
  : iServiceUpdateController;
begin
   Result := Self;
   FPrice := AValue;
