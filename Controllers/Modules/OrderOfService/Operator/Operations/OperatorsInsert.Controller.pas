...
function TOperatorInsertController.companyId(AValue: string): iOperatorInsertController;
begin
  Result := Self;
  FCompanyId := AValue;
end;
...
function TOperatorInsertController.name(AValue: string): iOperatorInsertController;
begin
  Result := Self;
  FName := AValue;
end;
...
function TOperatorInsertController.status(AValue: integer): iOperatorInsertController;
begin
  Result := Self;
  FStatus := AValue;
end;

function TOperatorInsertController.userId(AValue: string): iOperatorInsertController;
begin
  Result := Self;
  FUserId := AValue;
end;
