...
type
  TCityDuplicateController = class(TInterfacedObject,
  ...
  public
    ...
    function cityModel(AValue: iCityModel)
      : iCityDuplicateController;
...
function TCityDuplicateController.ibgeCode(AValue: string): iCityDuplicateController;
begin
  Result := Self;
  FIBGECode := StrToInt(AValue);
end;

function TCityDuplicateController.name(AValue: string): iCityDuplicateController;
begin
  Result := Self;
  FName := AValue;
end;
...
function TCityDuplicateController.stateId(AValue: string): iCityDuplicateController;
begin
  Result := Self;
  FStateId := AValue;
end;

function TCityDuplicateController.zipCode(AValue: string): iCityDuplicateController;
begin
 Result := Self;
 FZipCode := AValue;
end;
