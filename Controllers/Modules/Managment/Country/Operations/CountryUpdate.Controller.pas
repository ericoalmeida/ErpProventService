...
function TCountryUpdateController.countryModel(AValue: ICountryModel)
  : iCountryUpdateController;
begin
   Result := Self;
...
function TCountryUpdateController.name(AValue: string)
  : iCountryUpdateController;
begin
   Result := Self;
   FName := AValue;
...
function TCountryUpdateController.selectedRecord(AValue: TTMNGCOUNTRY)
  : iCountryUpdateController;
begin
   Result := Self;
