...
function TStateUpdateController.stateModel(AValue: IStateModel)
  : iStateUpdateController;
begin
   Result := Self;
   FStateModel := AValue;
end;

function TStateUpdateController.countryId(AValue: string)
  : iStateUpdateController;
begin
   Result := Self;
   FCountryId := AValue;
...
function TStateUpdateController.selectedRecord(AValue: TTMNGSTATE)
  : iStateUpdateController;
begin
   Result := Self;
...
function TStateUpdateController.initials(AValue: string)
  : iStateUpdateController;
begin
   Result := Self;
   FInitials := AValue;
