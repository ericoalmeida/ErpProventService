...
function TStateInsertController.countryId(AValue: string)
  : iStateInsertController;
begin
   Result := Self;
   FCountryId := AValue;
end;
...
function TStateInsertController.initials(AValue: string)
  : iStateInsertController;
begin
   Result := Self;
   FInitials := AValue;
...
function TStateInsertController.stateModel(AValue: IStateModel)
  : iStateInsertController;
begin
   Result := Self;
   FStateModel := AValue;
