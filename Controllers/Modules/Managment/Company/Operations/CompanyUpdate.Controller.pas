...
function TCompanyUpdateController.address(AValue: string): iCompanyUpdateController;
begin
  Result := Self;
  FAddress := AValue;
end;

function TCompanyUpdateController.companyModel(AValue: ICompanyModel): iCompanyUpdateController;
begin
  Result := Self;
  FCompanyModel := AValue;
end;

function TCompanyUpdateController.cpfcnpj(AValue: string): iCompanyUpdateController;
begin
  Result := Self;
  FCPFCNPJ := AValue;
end;
...
function TCompanyUpdateController.districtId(AValue: string): iCompanyUpdateController;
begin
  Result := Self;
  FDistrictId := AValue;
end;

function TCompanyUpdateController.email(AValue: string): iCompanyUpdateController;
begin
  Result := Self;
  FEmail := AValue;
end;

function TCompanyUpdateController.fancyName(AValue: string): iCompanyUpdateController;
begin
  Result := Self;
  FFancyName := AValue;
end;

function TCompanyUpdateController.name(AValue: string): iCompanyUpdateController;
begin
  Result := Self;
  FName := AValue;
end;
...
function TCompanyUpdateController.phoneNumber(AValue: string): iCompanyUpdateController;
begin
  Result := Self;
  FPhoneNumber := AValue;
end;

function TCompanyUpdateController.rgie(AValue: string): iCompanyUpdateController;
begin
  Result := Self;
  FRGIE := AValue;
end;
...
function TCompanyUpdateController.selectedRecord(AValue: TTMNGCOMPANY): iCompanyUpdateController;
begin
  Result := Self;
