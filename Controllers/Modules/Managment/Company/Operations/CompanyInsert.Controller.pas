...
function TCompanyInsertController.cpfcnpj(AValue: string)
...
function TCompanyInsertController.districtId(AValue: string)
  : iCompanyInsertController;
begin
   Result := Self;
   FDistrictId := AValue;
...
function TCompanyInsertController.email(AValue: string)
  : iCompanyInsertController;
begin
   Result := Self;
   FEmail := AValue;
...
function TCompanyInsertController.fancyName(AValue: string)
  : iCompanyInsertController;
begin
   Result := Self;
   FFancyName := AValue;
...
function TCompanyInsertController.name(AValue: string)
  : iCompanyInsertController;
begin
   Result := Self;
   FName := AValue;
...
function TCompanyInsertController.phoneNumber(AValue: string)
  : iCompanyInsertController;
begin
   Result := Self;
   FPhoneNumber := AValue;
...
function TCompanyInsertController.rgie(AValue: string)
  : iCompanyInsertController;
begin
   Result := Self;
   FRGIE := AValue;
...
function TCompanyInsertController.address(AValue: string)
  : iCompanyInsertController;
begin
   Result := Self;
   FAddress := AValue;
