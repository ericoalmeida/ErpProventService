...
function TCompanyDuplicateController.cpfcnpj(AValue: string)
  : iCompanyDuplicateController;
begin
   Result := Self;
   FCPFCNPJ := AValue;
...
function TCompanyDuplicateController.address(AValue: string)
  : iCompanyDuplicateController;
begin
   Result := Self;
   FAddress := AValue;
...
function TCompanyDuplicateController.districtId(AValue: string)
  : iCompanyDuplicateController;
begin
   Result := Self;
   FDistrictId := AValue;
...
function TCompanyDuplicateController.email(AValue: string)
  : iCompanyDuplicateController;
begin
   Result := Self;
   FEmail := AValue;
...
function TCompanyDuplicateController.fancyName(AValue: string)
  : iCompanyDuplicateController;
begin
   Result := Self;
   FFancyName := AValue;
...
begin
   if FCompanyModel.DAO.Find.Count <> 0 then
   begin
      Result := FCompanyModel.DAO.FindWhere('', 'COMPANYID desc')
        .Last.COMPANYID + 1;
   end
   else
   begin
...
function TCompanyDuplicateController.name(AValue: string)
  : iCompanyDuplicateController;
begin
   Result := Self;
   FName := AValue;
...
function TCompanyDuplicateController.phoneNumber(AValue: string)
  : iCompanyDuplicateController;
begin
   Result := Self;
   FPhoneNumber := AValue;
...
function TCompanyDuplicateController.rgie(AValue: string)
  : iCompanyDuplicateController;
begin
   Result := Self;
   FRGIE := AValue;
