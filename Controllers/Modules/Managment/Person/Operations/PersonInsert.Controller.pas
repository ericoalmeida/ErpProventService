...
function TPersonInsertController.address(AValue: string): iPersonInsertController;
begin
  Result := Self;
  FAddress := AValue;
end;

function TPersonInsertController.companyId(AValue: string): iPersonInsertController;
begin
  Result := Self;
  FCompanyId := AValue;
end;

function TPersonInsertController.CPFCNPJ(AValue: string): iPersonInsertController;
begin
  Result := Self;
  FCPFCNPJ := AValue;
end;
...
function TPersonInsertController.districtId(AValue: string): iPersonInsertController;
begin
  Result := Self;
  FDistrictId := AValue;
end;
...
function TPersonInsertController.fancyName(AValue: string): iPersonInsertController;
begin
  Result := Self;
  FFancyName := AValue;
end;
...
function TPersonInsertController.status(AValue: Integer): iPersonInsertController;
begin
  Result := Self;
  FStatus := AValue;
end;

function TPersonInsertController.userId(AValue: string): iPersonInsertController;
begin
  Result := Self;
  FUserId := AValue;
end;
...
function TPersonInsertController.personType(AValue: Integer): iPersonInsertController;
begin
  Result := Self;
  FPersonType := AValue;
end;

function TPersonInsertController.phoneNumber(AValue: string): iPersonInsertController;
begin
  Result := Self;
  FPhoneNumber := AValue;
end;
