...
type
  ...
  public
    ...
    [ForeignKey('FK1_TMNGPERSON', 'COMPANYID', 'TMNGCOMPANY', 'CODE', SetNull, SetNull)]
    ...
    [Dictionary('FANCYNAME', 'Mensagem de validação', '', '', '', taLeftJustify)]
    ...
    [Dictionary('ADDRESS', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property ADDRESS: String read FADDRESS write FADDRESS;

    [Restrictions([NotNull])]
    [Column('DISTRICTID', ftString, 64)]
    [ForeignKey('FK2_TMNGPERSON', 'DISTRICTID', 'TMNGDISTRICT', 'CODE', SetNull, SetNull)]
    [Dictionary('DISTRICTID', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property DISTRICTID: String read FDISTRICTID write FDISTRICTID;

    [Column('PHONENUMBER', ftString, 15)]
    [Dictionary('PHONENUMBER', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PHONENUMBER: Nullable<String> read FPHONENUMBER write FPHONENUMBER;
    ...
    [ForeignKey('FK3_TMNGPERSON', 'USERID', 'TMNGUSER', 'CODE', SetNull, SetNull)]
    ...
    property TMNGDISTRICT: TTMNGDISTRICT read FTMNGDISTRICT_1 write FTMNGDISTRICT_1;
