...
type
   ...
   public
      ...
      [Dictionary('INITIALS', 'Mensagem de validação', '', '', '',
        taLeftJustify)]
      property INITIALS: String read FINITIALS write FINITIALS;

      [Restrictions([NotNull])]
      [Column('COUNTRYID', ftString, 64)]
      [ForeignKey('FK1_TMNGSTATE', 'COUNTRYID', 'TMNGCOUNTRY', 'CODE',
        SetNull, SetNull)]
      [Dictionary('COUNTRYID', 'Mensagem de validação', '', '', '',
        taLeftJustify)]
      ...
      property TMNGCOUNTRY: TTMNGCOUNTRY read FTMNGCOUNTRY_0
        write FTMNGCOUNTRY_0;
