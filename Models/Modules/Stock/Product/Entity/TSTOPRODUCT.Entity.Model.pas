...
constructor TTSTOPRODUCT.Create;
begin
  FTMNGCOMPANY_0 := TTMNGCOMPANY.Create;
  FTMNGUSER_1 := TTMNGUSER.Create;
end;

destructor TTSTOPRODUCT.Destroy;
begin
...
function TTSTOPRODUCT.GETCODE: String;
begin
...
initialization
  TRegisterClass.RegisterEntity(TTSTOPRODUCT)
