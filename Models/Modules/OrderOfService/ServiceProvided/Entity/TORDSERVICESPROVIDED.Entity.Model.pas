...
type
   ...
   public
      ...
      [ForeignKey('FK0_TORDSERVICESPROVIDED', 'COMPANYID', 'TMNGCOMPANY',
        'CODE', SetNull, SetNull)]
      ...
      [Dictionary('SERVICEPROVIDEDID', 'Mensagem de validação', '', '', '',
        taCenter)]
      property SERVICEPROVIDEDID: Integer read FSERVICEPROVIDEDID
        write FSERVICEPROVIDEDID;

      [Restrictions([NotNull])]
      [Column('PROVIDEDAT', ftDateTime)]
      [Dictionary('PROVIDEDAT', 'Mensagem de validação', 'Date', '',
        '!##/##/####;1;_', taCenter)]
      property PROVIDEDAT: TDateTime read FPROVIDEDAT write FPROVIDEDAT;

      [Restrictions([NotNull])]
      [Column('CLIENTID', ftString, 64)]
      [ForeignKey('FK1_TORDSERVICESPROVIDED', 'COMPANYID, CLIENTID',
        'TMNGPERSON', 'COMPANYID, CODE', SetNull, SetNull)]
      [Dictionary('CLIENTID', 'Mensagem de validação', '', '', '',
        taLeftJustify)]
      property CLIENTID: String read FCLIENTID write FCLIENTID;

      [Column('OPERATORID', ftString, 64)]
      [ForeignKey('FK2_TORDSERVICESPROVIDED', 'COMPANYID, OPERATORID',
        'TORDOPERATOR', 'COMPANYID, CODE', SetNull, SetNull)]
      [Dictionary('OPERATORID', 'Mensagem de validação', '', '', '',
        taLeftJustify)]
      property OPERATORID: nullable<String> read FOPERATORID write FOPERATORID;

      [Column('MACHINEID', ftString, 64)]
      [ForeignKey('FK3_TORDSERVICESPROVIDED', 'COMPANYID, MACHINEID',
        'TASSVEHICLE', 'COMPANYID, CODE', SetNull, SetNull)]
      [Dictionary('MACHINEID', 'Mensagem de validação', '', '', '',
        taLeftJustify)]
      property MACHINEID: nullable<String> read FMACHINEID write FMACHINEID;

      [Restrictions([NotNull])]
      [Column('SERVICEID', ftString, 64)]
      [ForeignKey('FK4_TORDSERVICESPROVIDED', 'COMPANYID, SERVICEID',
        'TORDSERVICE', 'COMPANYID, CODE', SetNull, SetNull)]
      [Dictionary('SERVICEID', 'Mensagem de validação', '', '', '',
        taLeftJustify)]
      property SERVICEID: String read FSERVICEID write FSERVICEID;

      [Column('TOTALKM', ftBCD)]
      [Dictionary('TOTALKM', 'Mensagem de validação', '0', '', '',
        taRightJustify)]
      ...
      [Restrictions([NotNull])]
      [Column('TOTAL', ftBCD)]
      [Dictionary('TOTAL', 'Mensagem de validação', '0', '', '',
        taRightJustify)]
      ...
      [ForeignKey('FK5_TORDSERVICESPROVIDED', 'USERID', 'TMNGUSER', 'CODE',
        SetNull, SetNull)]
      ...
      [Association(OneToOne, 'COMPANYID, MACHINEID', 'TASSVEHICLE',
        'COMPANYID, CODE')]
      property TASSVEHICLE: TTASSVEHICLE read FTASSVEHICLE_0
        write FTASSVEHICLE_0;

      [Association(OneToOne, 'COMPANYID', 'TMNGCOMPANY', 'CODE')]
      property TMNGCOMPANY: TTMNGCOMPANY read FTMNGCOMPANY_1
        write FTMNGCOMPANY_1;

      [Association(OneToOne, 'COMPANYID, CLIENTID', 'TMNGPERSON',
        'COMPANYID, CODE')]
      ...
      [Association(OneToOne, 'COMPANYID, OPERATORID', 'TORDOPERATOR',
        'COMPANYID, CODE')]
      property TORDOPERATOR: TTORDOPERATOR read FTORDOPERATOR_4
        write FTORDOPERATOR_4;

      [Association(OneToOne, 'COMPANYID, SERVICEID', 'TORDSERVICE',
        'COMPANYID, CODE')]
      property TORDSERVICE: TTORDSERVICE read FTORDSERVICE_5
        write FTORDSERVICE_5;
