...
begin
   FProviderController.delete.save;
end;
...
begin
   FProviderController.duplicate.companyId(FSessionCompany)
     .personType(Integer(tpProvider)).name(TxName.Text)
...
begin
   FProviderController.insert.companyId(FSessionCompany)
     .personType(Integer(tpProvider)).name(TxName.Text)
     .fancyName(TxFancyName.Text).CPFCNPJ(TxCNPJ.Text).RGIE(TxIE.Text)
     .address(TxAddress.Text).districtId(FDistrictController.code)
     .phoneNumber(TxPhoneNumber.Text).email(TxEmail.Text)
...
begin
   FProviderController.update.companyId(FSessionCompany)
     .personType(Integer(tpProvider)).name(TxName.Text)
     .fancyName(TxFancyName.Text).CPFCNPJ(TxCNPJ.Text).RGIE(TxIE.Text)
     .address(TxAddress.Text).districtId(FDistrictController.code)
     .phoneNumber(TxPhoneNumber.Text).email(TxEmail.Text)
