...
type
   TFPAY0001AView = class(TFBaseListView, iBaseListView)
...
procedure TFPAY0001AView.BtDeleteClick(Sender: TObject);
begin
   inherited;
...
procedure TFPAY0001AView.BtDuplicateClick(Sender: TObject);
begin
   inherited;
...
procedure TFPAY0001AView.BtInsertClick(Sender: TObject);
begin
   inherited;
...
procedure TFPAY0001AView.BtShowClick(Sender: TObject);
begin
   inherited;
...
procedure TFPAY0001AView.BtUpdateClick(Sender: TObject);
begin
   inherited;
...
procedure TFPAY0001AView.deleteRecord;
begin
   TFacadeView.New.modulesFacadeView.payFactory.showProgramOfRegister
     (trPAY0001BView).operation(FOperation)
     .selectedRecord(FdQDataCODE.AsString).&end;
end;

procedure TFPAY0001AView.duplicateRecord;
begin
   TFacadeView.New.modulesFacadeView.payFactory.showProgramOfRegister
     (trPAY0001BView).operation(FOperation)
     .selectedRecord(FdQDataCODE.AsString).&end;
...
procedure TFPAY0001AView.&end;
begin

   Show;
end;

procedure TFPAY0001AView.FormCreate(Sender: TObject);
begin
   inherited;
...
procedure TFPAY0001AView.FormShow(Sender: TObject);
begin
   inherited;
   FFieldOrder := 'NAME';
...
procedure TFPAY0001AView.insertRecord;
begin
   TFacadeView.New.modulesFacadeView.payFactory.showProgramOfRegister
     (trPAY0001BView).operation(FOperation).&end;
end;

procedure TFPAY0001AView.listRecords;
begin
...
class function TFPAY0001AView.New: iBaseListView;
begin
   Result := Self.Create(nil);
end;

procedure TFPAY0001AView.showRecord;
begin
   TFacadeView.New.modulesFacadeView.payFactory.showProgramOfRegister
     (trPAY0001BView).operation(FOperation)
     .selectedRecord(FdQDataCODE.AsString).&end;
...
procedure TFPAY0001AView.TxBuscarPropertiesChange(Sender: TObject);
begin
   inherited;
...
procedure TFPAY0001AView.updateRecord;
begin
   TFacadeView.New.modulesFacadeView.payFactory.showProgramOfRegister
     (trPAY0001BView).operation(FOperation)
     .selectedRecord(FdQDataCODE.AsString).&end;
