...
uses
   ...
   Vcl.Menus, dxSkinsCore, dxSkinDarkRoom, dxSkinDarkSide,
   dxSkinDevExpressDarkStyle,
   dxSkinDevExpressStyle, cxControls, cxContainer, cxEdit, cxStyles,
   ...
   RzLabel,
   dxGDIPlusClasses, Vcl.ExtCtrls, RzPanel, Datasnap.DBClient,
...
begin
   try
      ...
      begin
         ...
         FMessage.Messages('Arquivo inválido!').&end;
      end;
...
begin
   ...
   FMessage := TFacadeView.New.messagesFactoryView.typeMessage(tmWarning);
end;
...
begin
   ...
   try
      ...
      begin
         ...
         CdDataDESCRIPTION.AsString := removeWhiteSpacesOnText
         ...
         CdDataAVERAGEPRICE_SINAPI.AsCurrency :=
           StrToFloat(formatTextInAPrice(MontaValor));
         CdData.Post;
...
begin
   ...
   begin
      ...
      FImportSinapiProductController.find(CdDataCODE_SINAPI.AsString)
        .import.currentProduct(FImportSinapiProductController.recordFound)
        ...
        .averagePriceSinapi(CdDataAVERAGEPRICE_SINAPI.AsCurrency).status(0)
        .userId('{177524BA-A3DA-4ECC-BFA4-388A3A06DF9F}').save;
