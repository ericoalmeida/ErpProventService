...
uses
   ...
   Base.View.interf,
   Types.Controllers, cxControls, cxContainer, cxEdit, cxTextEdit, cxLabel,
   cxMaskEdit,
   cxDropDownEdit, Operators.Controller.interf, ERGTextEdit;
...
begin
   FOperatorController.delete.save;
end;
...
begin
   FOperatorController.duplicate.companyId(FSessionCompany)
     .name(TxDescription.Text).status(CbStatus.ItemIndex)
...
begin
   FOperatorController.insert.companyId(FSessionCompany)
     .name(TxDescription.Text).status(CbStatus.ItemIndex)
     .userId(FSessionUser).save;
end;
...
begin
   FOperatorController.update.companyId(FSessionCompany)
     .name(TxDescription.Text).status(CbStatus.ItemIndex)
     .userId(FSessionUser).save;
end;
