...
begin
   inherited;
   TFacadeView.New.modulesFacadeView.orderOfServiceFactory.
     showORD0003DReport.show;
end;
...
begin
   TFacadeView.New.modulesFacadeView.orderOfServiceFactory.showProgramOfRegister
     (trORD0003BView).operation(FOperation)
...
begin
   TFacadeView.New.modulesFacadeView.orderOfServiceFactory.showProgramOfRegister
     (trORD0003BView).operation(FOperation).&end;
end;
