...
uses
   ...
   Base.View.interf, Types.Controllers, Person.Controller.interf,
...
begin
   FClientController.duplicate.companyId(FSessionCompany)
     .personType(Integer(tpClient)).name(TxName.Text)
     .fancyName(TxFancyName.Text).CPFCNPJ(TxCNPJ.Text).RGIE(TxIE.Text)
     .address(TxAddress.Text).districtId(FDistrictController.code)
     .phoneNumber(TxPhoneNumber.Text).email(TxEmail.Text)
     .status(CbStatus.ItemIndex).userId(FSessionUser).save;
end;
...
begin
   FClientController.insert.companyId(FSessionCompany)
     .personType(Integer(tpClient)).name(TxName.Text)
     .fancyName(TxFancyName.Text).CPFCNPJ(TxCNPJ.Text).RGIE(TxIE.Text)
     .address(TxAddress.Text).districtId(FDistrictController.code)
     .phoneNumber(TxPhoneNumber.Text).email(TxEmail.Text)
...
begin
   FClientController.update.companyId(FSessionCompany)
     .personType(Integer(tpClient)).name(TxName.Text)
     .fancyName(TxFancyName.Text).CPFCNPJ(TxCNPJ.Text).RGIE(TxIE.Text)
     .address(TxAddress.Text).districtId(FDistrictController.code)
     .phoneNumber(TxPhoneNumber.Text).email(TxEmail.Text)
