...
begin
   FStateController.duplicate.name(TxName.Text).initials(TxInitials.Text)
     .countryId(FCountryController.codigo).save;
end;
...
begin
   FStateController.insert.name(TxName.Text).initials(TxInitials.Text)
     .countryId(FCountryController.codigo).save;
end;
...
begin
   FStateController.update.name(TxName.Text).initials(TxInitials.Text)
     .countryId(FCountryController.codigo).save;
end;
