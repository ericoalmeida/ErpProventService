...
begin
   FCityController.duplicate.name(TxName.Text).zipCode(TxZipCode.Text)
     .ibgeCode(TxIBGECode.Text).stateId(FStateController.code).save;
end;
...
begin
   FCityController.insert.name(TxName.Text).zipCode(TxZipCode.Text)
     .ibgeCode(TxIBGECode.Text).stateId(FStateController.code).save;
end;
...
begin
   FCityController.update.name(TxName.Text).zipCode(TxZipCode.Text)
     .ibgeCode(TxIBGECode.Text).stateId(FStateController.code).save;
end;
