...
uses
   ...
   Base.View.interf, TMNGCOUNTRY.Entity.Model,
   ormbr.container.DataSet.interfaces,
   ormbr.container.fdmemtable, FireDAC.Stan.Async, FireDAC.DApt,
   dxSkinOffice2016Colorful,
   dxSkinOffice2016Dark, dxSkinOffice2007Black, dxSkinOffice2007Blue,
   dxSkinOffice2007Green,
   dxSkinOffice2007Silver, dxSkinDarkRoom, dxSkinDarkSide, System.ImageList,
...
begin
   TFacadeView.new.modulesFacadeView.ManagmentFactoryView.showProgramOfRegister
     (trMNG0002BView).operation(FOperation)
...
begin
   TFacadeView.new.modulesFacadeView.ManagmentFactoryView.showProgramOfRegister
     (trMNG0002BView).operation(FOperation).&end;
end;
