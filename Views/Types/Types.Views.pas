...
type
  ...
  TTypeListingPrograms = (tpMNG0001AView, tpMNG0002AView, tpMNG0003AView,
    ...
    tpASS0002AView, tpORD0001AView, tpORD0002AView, tpSTO0001AView,
    tpREC0001AView, tpPAY0001AView);
  ...
  TTypeRegisterPrograms = (trMNG0001BView, trMNG0002BView, trMNG0003BView,
    ...
    trASS0002BView, trORD0001BView, trORD0002BView, trSTO0001BView,
    trREC0001BView, trPAY0001BView);
